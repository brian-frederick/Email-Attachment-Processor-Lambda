...
Once you have edited your function you can use the following command lines to build, test and deploy your function to AWS Lambda from the command line (these examples assume the project name is *Email-Attachment-Processor-Lambda*):

Restore dependencies
```
    cd "Email-Attachment-Processor-Lambda"
    dotnet restore
```

Execute unit tests
```
    cd "Email-Attachment-Processor-Lambda/test/Email-Attachment-Processor-Lambda.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Email-Attachment-Processor-Lambda/src/Email-Attachment-Processor-Lambda"
